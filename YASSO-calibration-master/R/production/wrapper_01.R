...
# Seed 250 All ecosystems without QC
# Seed 251 All ecosystems with QC
# Seed 252 Grasslands without QC
# Seed 253 Grasslands with QC
# Seed 254 Semi-forest without QC
# Seed 255 Semi-forest with QC
# Seed 256 Forest without QC
# Seed 257 Forest with QC
...
# datasets <- c("ed1", "ed2", "cidet", "lidet", "gss", "makinen", "hob3")
...
default_par <- read.csv(
  file = paste0(path_main_dir, "parameters/defaults_and_priors.csv"),
  colClasses = c("character", rep("numeric", 3))
)

# Import starting values for the chains
inits <- as.matrix(read.csv(
  file = paste0(path_main_dir, "parameters/starting_values.csv"))
)
